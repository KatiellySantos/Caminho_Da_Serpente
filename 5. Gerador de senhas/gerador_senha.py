...
letras = string.ascii_letters  # Todas as letras maiúsculas e minúsculas
numeros = string.digits  # Todos os números de 0 a 9
simbolos = "!@#$%^&*()"  # Símbolos válidos para a senha
...
if senha > 0:
    ...
    print("Senha gerada:", senha_gerada)  # Exibe a senha gerada
else:
    print("Erro: O tamanho da senha deve ser maior que 0.")  # Mensagem de erro para entrada inválida
